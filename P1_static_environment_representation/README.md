...
[Detailed Design Document](./1_radar_static_environment_representation.pdf) <br>
[Python Code](./python) <br>
[Result Videos](./result_gifs)
...
[Animation for longer sequence of radar frames](./readme_artifacts/all_radar_meas_long_seq.gif)
![](./readme_artifacts/all_radar_meas_short_seq.gif)
...
![](./readme_artifacts/4_seq_diag.PNG)
...
In this section we show videos of the results.
   ...
   [Longer Animation Sequence Link](./result_gifs/radar_dense_point_cloud_long_seq.gif)
   ![](./result_gifs/radar_dense_point_cloud_short_seq.gif)

   2. **Free Space Computation** <br>
   [Longer Animation Sequence Link](./result_gifs/free_space_computation_radar_long_seq.gif)
   ![](./result_gifs/free_space_computation_radar_short_seq.gif)

   3. **Road Boundary Point Extraction** <br>
   [Longer Animation Sequence Link](./result_gifs/road_boundary_long_seq.gif)
   ![](./result_gifs/road_boundary_short_seq.gif)
